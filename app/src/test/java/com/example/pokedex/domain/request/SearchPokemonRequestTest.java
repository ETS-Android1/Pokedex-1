...
public class SearchPokemonRequestTest {
    @Rule public InstantTaskExecutorRule instantExecutorRule = new InstantTaskExecutorRule();

    @Mock private DataRepository dataRepository;

    @InjectMocks private SearchPokemonRequest searchPokemonRequest;

    @Captor private ArgumentCaptor<String> stringCaptor;
    @Captor private ArgumentCaptor<DataResult.Callback<Pokemon>> callbackCaptor;

    @Test
    public void requestPokemonSearch(){
        String expectedPokemonName = "pikachu";

        searchPokemonRequest.requestPokemonSearch(expectedPokemonName);
    ...
    public void requestPokemonDetail_setPokemonLiveData() throws InterruptedException {
        ...
        searchPokemonRequest.requestPokemonSearch(pokemon.getName());
        ...
        Event<DataResult<Pokemon>> event = LiveDataTestUtil.getValue(searchPokemonRequest.getPokemonLiveData());
        DataResult<Pokemon> actualDataResult = event.getContentIfNotHandled(getClass().getName());
